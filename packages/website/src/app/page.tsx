  ...
  return (
    <main>
      <div className="px-16 max-w-[1420px] mx-auto">
        <h3 className="text-8xl font-bold text-center pt-56 pb-14 tracking-tighter">Minimal, clean icons.</h3>
        ...
        <div className="flex flex-wrap gap-1">
          {Object.keys(icons).map((iconName) => {
            if (iconName.endsWith('-line')) {
              return <IconComponent iconName={iconName} key={iconName} svgContent={icons[iconName].svgContent} />;
            }
          })}
        </div>
        <div className="flex flex-wrap gap-1">
