  ...
  return (
    <main>
      <div className="px-4 sm:px-10 md:px-16 max-w-[1400px] mx-auto">
        <h3 className="text-6xl sm:text-8xl font-bold text-center pt-56 pb-8 sm:pb-14 tracking-tighter">
          Minimal, clean icons.
        </h3>
...
function CategoryIcons({ icons, categoryName }: { icons: IconArrayItemType[]; categoryName: string }) {
  ...
  return (
    <div className="mb-24">
      ...
      <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:gap-14 xl:gap-[136px] items-start justify-between">
