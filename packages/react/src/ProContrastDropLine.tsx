...
export const ProContrastDropLine = React.forwardRef<SVGSVGElement, IconProps>(
  ({ color = "currentColor", ...props }, forwardedRef) => {
    return (
      <svg
        ...
        ref={forwardedRef}
      >
        <path fill={color} d="M17 13a5 5 0 0 0-5-5v10a5 5 0 0 0 5-5" />
        <path
          fill={color}
...
export default ProContrastDropLine;
