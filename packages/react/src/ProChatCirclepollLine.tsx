...
export const ProChatCirclepollLine = React.forwardRef<SVGSVGElement, IconProps>(
  ({ color = "currentColor", ...props }, forwardedRef) => {
    return (
      <svg
        ...
        ref={forwardedRef}
      >
        <path fill={color} d="M7 12v4h2v-4zm8 4v-6h2v6zm-2-8h-2v8h2z" />
        <path
          fill={color}
...
export default ProChatCirclepollLine;
