...
export const ProHeavyShowersLine = React.forwardRef<SVGSVGElement, IconProps>(
  ({ color = "currentColor", ...props }, forwardedRef) => {
    return (
      ...
      >
        ...
        />
        <path fill={color} d="M7 15v6h2v-6zm4 8v-6h2v6zm4-8v6h2v-6z" />
      </svg>
    );
  },
);

export default ProHeavyShowersLine;
