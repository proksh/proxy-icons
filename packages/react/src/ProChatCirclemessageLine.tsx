...
export const ProChatCirclemessageLine = React.forwardRef<
  SVGSVGElement,
  IconProps
>(({ color = "currentColor", ...props }, forwardedRef) => {
  return (
    <svg
      ...
      ref={forwardedRef}
    >
      <path fill={color} d="M7 13h2v-2H7zm10 0h-2v-2h2zm-6 0h2v-2h-2z" />
      <path
        fill={color}
...
export default ProChatCirclemessageLine;
