...
export const ProShowersFill = React.forwardRef<SVGSVGElement, IconProps>(
  ({ color = "currentColor", ...props }, forwardedRef) => {
    return (
      ...
      >
        ...
        />
        <path fill={color} d="M7 16v4h2v-4zm4 7v-4h2v4zm6-7h-2v4h2z" />
      </svg>
    );
  },
);

export default ProShowersFill;
