...
export const ProThunderstormsFill = React.forwardRef<SVGSVGElement, IconProps>(
  ({ color = "currentColor", ...props }, forwardedRef) => {
    return (
      ...
      >
        ...
        />
        <path fill={color} d="m16 17-5 6.5V19H8l5-6.5V17z" />
      </svg>
    );
  },
);

export default ProThunderstormsFill;
