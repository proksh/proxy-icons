...
export const ProChatCirclequestionnaireLine = React.forwardRef<
  SVGSVGElement,
  IconProps
>(({ color = "currentColor", ...props }, forwardedRef) => {
  return (
    ...
    >
      <path
        fill={color}
        d="M12 9a1.5 1.5 0 0 0-1.47 1.199L8.57 9.8A3.5 3.5 0 1 1 12 14h-1v-2h1a1.5 1.5 0 0 0 0-3m-1 8v-2h2v2z"
      />
      <path
        fill={color}
...
export default ProChatCirclequestionnaireLine;
