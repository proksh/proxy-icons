...
export const ProThunderstormsLine = React.forwardRef<SVGSVGElement, IconProps>(
  ({ color = "currentColor", ...props }, forwardedRef) => {
    return (
      ...
      >
        ...
        />
        <path fill={color} d="M13 12.5 8 19h3v4.5l5-6.5h-3z" />
      </svg>
    );
  },
);

export default ProThunderstormsLine;
