...
export const ProChatCirclefollowUpLine = React.forwardRef<
  SVGSVGElement,
  IconProps
>(({ color = "currentColor", ...props }, forwardedRef) => {
  return (
    <svg
      ...
      ref={forwardedRef}
    >
      <path fill={color} d="M17 9h-2v6h2zm-6 6v-2h2v-2h-2V9H9v2H7v2h2v2z" />
      <path
        fill={color}
...
export default ProChatCirclefollowUpLine;
